...
Rectangle {
    ...
    property int automationSelected: -1
        ...
        Repeater {
            ...
            delegate: Column {
                ...
                DefaultImageButton {
                    ...
                    height: 32
                    scaleFactor: 1
                    visible: controlsFlow.showAutomations
                    source: controlsFlow.showAutomations ? "qrc:/Assets/Automation.png" : ""
                    colorDefault: controlsFlow.automationSelected === index ? controlsFlow.nodeColor : "white"
                    colorHovered: controlsFlow.nodeHoveredColor
                    colorOnPressed: controlsFlow.nodePressedColor

                    onReleased: {
                        if (controlsFlow.automationSelected === index)
                            controlsFlow.automationSelected = -1
                        else
                            controlsFlow.automationSelected = index
                    }
                }
            }
        }
