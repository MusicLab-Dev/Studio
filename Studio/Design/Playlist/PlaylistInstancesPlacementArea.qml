...
MouseArea {
    ...
    property int mode: PlaylistInstancesPlacementArea.Mode.None
    ...
    onPressed: {
        ...
        if (mouse.buttons & Qt.RightButton) {
            resetSelection()
            mode = PlaylistInstancesPlacementArea.Mode.Remove
            if (isSelection) {
                mode = PlaylistInstancesPlacementArea.Mode.SelectRemove
        ...
        if (instanceIndex === -1) {
            ...
            if (isSelection) {
                mode = PlaylistInstancesPlacementArea.Mode.Select
                selectionBeatPrecisionFrom = realMouseBeatPrecision
                selectionBeatPrecisionTo = realMouseBeatPrecision
                return
            }
            ...
            if (playlistView.editMode === PlaylistView.EditMode.Brush) {
                mode = PlaylistInstancesPlacementArea.Mode.Brush
            ...
            // Move mode, attach preview
                ...
                mode = PlaylistInstancesPlacementArea.Mode.Move
        ...
        // Left click on instance -> edit
            ...
            if ((realMouseBeatPrecision - beatPrecisionRange.from) * contentView.pixelsPerBeatPrecision <= resizeThreshold)
                mode = isPartOfSelection ? PlaylistInstancesPlacementArea.Mode.SelectLeftResize : PlaylistInstancesPlacementArea.Mode.LeftResize
            else if ((beatPrecisionRange.to - realMouseBeatPrecision) * contentView.pixelsPerBeatPrecision <= resizeThreshold)
                mode = isPartOfSelection ? PlaylistInstancesPlacementArea.Mode.SelectRightResize : PlaylistInstancesPlacementArea.Mode.RightResize
            else
                mode = isPartOfSelection ? PlaylistInstancesPlacementArea.Mode.SelectMove : PlaylistInstancesPlacementArea.Mode.Move
            if (mode < PlaylistInstancesPlacementArea.Mode.Select) {
                resetSelection()
                instances.remove(instanceIndex)
            } else {
    ...
    onPositionChanged: {
        ...
        switch (mode) {
        case PlaylistInstancesPlacementArea.Mode.Remove:
            var instanceIndex = instances.find(realMouseBeatPrecision)
            if (instanceIndex !== -1)
                instances.remove(instanceIndex)
            break
        case PlaylistInstancesPlacementArea.Mode.Move:
        case PlaylistInstancesPlacementArea.Mode.SelectMove:
            ...
            if (mode === PlaylistInstancesPlacementArea.Mode.SelectMove)
                selectionMoveBeatPrecisionOffset += (contentView.placementBeatPrecisionFrom - oldBeat)
            break
        case PlaylistInstancesPlacementArea.Mode.LeftResize:
        case PlaylistInstancesPlacementArea.Mode.SelectLeftResize:
            var mouseBeatPrecision = realMouseBeatPrecision
            ...
            if (mode === PlaylistInstancesPlacementArea.Mode.SelectLeftResize && contentView.placementBeatPrecisionFrom != oldFrom)
                selectionList.resizeLeft(contentView.placementBeatPrecisionFrom - oldFrom)
            break
        case PlaylistInstancesPlacementArea.Mode.RightResize:
        case PlaylistInstancesPlacementArea.Mode.SelectRightResize:
            var mouseBeatPrecision = realMouseBeatPrecision
            if (contentView.placementBeatPrecisionScale !== 0)
            ...
            if (mode === PlaylistInstancesPlacementArea.Mode.SelectRightResize && contentView.placementBeatPrecisionTo != oldTo)
                selectionList.resizeRight(contentView.placementBeatPrecisionTo - oldTo)
            break
        case PlaylistInstancesPlacementArea.Mode.Brush:
            var mouseBeatPrecision = realMouseBeatPrecision
            ...
            break
        case PlaylistInstancesPlacementArea.Mode.Select:
        case PlaylistInstancesPlacementArea.Mode.SelectRemove:
            selectionBeatPrecisionTo = realMouseBeatPrecision
            break
        default:
            break
    ...
    onReleased: {
        ...
        mode = PlaylistInstancesPlacementArea.Mode.None
    }
    ...
    Rectangle {
        ...
        border.width: 2
        visible: mode === PlaylistInstancesPlacementArea.Mode.Brush
    ...
    Rectangle {
        id: selectionOverlay
        visible: mode === PlaylistInstancesPlacementArea.Mode.Select || mode === PlaylistInstancesPlacementArea.Mode.SelectRemove
