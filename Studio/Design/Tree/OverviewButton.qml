...
Item {
    ...
    Rectangle {
        ...
        color: overviewMouse.containsMouse ? overview.runtimeColor : themeManager.panelColor
    }
    ...
    DefaultText {
        ...
        color: overviewMouse.containsMouse ? themeManager.panelColor : overview.runtimeColor
    }
}
